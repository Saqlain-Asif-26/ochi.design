...
function Footer() {
  return (
    <div className='w-full h-screen p-20 flex gap-5 overflow-hidden'>
        <div className='w-1/2 h-full flex flex-col justify-between uppercase font-founders'>
            <div className="heading">
                <h1 className='text-[8vw] leading-none -mb-8'>Eye-</h1>
                <h1 className='text-[8vw] leading-none -mb-8'>Opening</h1>
            </div>
        ...
        <div className='w-1/2 h-full'>
            <h1 className='text-[8vw] leading-none -mb-8 font-founders'>Presentations</h1>
            <div className='flex flex-col justify-between h-full font-neue mt-10 pb-28'>
                <div>
                ...
                <div>
                    ...
                    <a href="mailto:rsaqlainasif26@gmail.com">rsaqlainasif26@gmail.com</a>
                </div>
                <div className='flex justify-between text-zinc-600 text-lg'>
                    <div className='flex'>
                        <p>&copy; ochi design 2024.</p>
                        <p>Legal Terms</p>
                    </div>
                    <div>Website by Saqlain</div>
                </div>
            </div>
        </div>
    </div>
